#!/usr/bin/env python3
"""Run fold-isolated experiments with shared preprocessing and checkpoints."""
...
try:
    ...
    # Support importing the runner as ``src.run_experiments`` in
...
def main():
    ...
    if metadata_path.exists() and not args.no_resume:
        ...
        # Preserve an checkpoint history created by an explicit checkpoint
